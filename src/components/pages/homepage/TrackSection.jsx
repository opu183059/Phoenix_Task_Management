...
//     {
//       image:
//         "https://plus.unsplash.com/premium_photo-1679086008296-3b96ebec8ded?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGNvcnJlY3R8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60",
//       title: "12 done",
//       text: "",
//     },
//     {
//       image:
//         "https://img.freepik.com/premium-photo/3d-render-clipboard-with-checklist-concept-project-management-isolated-purple-background_95505-349.jpg?size=626&ext=jpg&ga=GA1.2.488912096.1690217426&semt=sph",
//       title: "10 updated",
//     },
//     {
//       image:
//         "https://img.freepik.com/free-photo/3d-render-astronaut-with-target-3d-illustration-design_460848-10855.jpg?size=626&ext=jpg&ga=GA1.2.488912096.1690217426&semt=sph",
//       title: "4 new",
//     },
//     {
//       image:
//         "https://img.freepik.com/free-photo/3d-render-calendar-page-with-green-tick-icon_107791-15944.jpg?size=626&ext=jpg&ga=GA1.2.488912096.1690217426&semt=sph",
//       title: "3 due",
//     },
//   ];
//   const upcomingWork = [
...
//   return (
//     <div className="bg-[url('https://static.vecteezy.com/system/resources/previews/011/171/111/original/white-background-with-orange-geometric-free-vector.jpg')] bg-fixed bg-cover p-6 md:p-12">
...
//           Get insight into what your project update
//         </h2>
//         <p className="mb-12 backdrop-blur-[2px]">
//           Allocate resources, including people, materials, and equipment, based
//           on the project plan. Ensure that resources are available when
//           needed.Implement the project plan by performing tasks as outlined.
//           Regularly monitor progress, track tasks, and ensure that work is being
//           carried out according to schedule. Identify potential risks that could
//           impact the success. Develop strategies to mitigate or respond to these
//           risks to minimize their impact.Monitor and review project milestones
//           to assess progress and identify any delays from the original plan.
//         </p>
//       </div>
...
//           <div
//             className="flex items-center p-4 border space-x-4 bg-white rounded-md"
//             key={index}
//           >
//             <img
//               src={card.image}
